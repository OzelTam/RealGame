...
{
    public class GameRectangleShape : RectangleShape, IGameShape
    {
        ...
        public GameRectangleShape(string? id = null, string tag = "rectangle")
        {
        ...
        public GameRectangleShape(Vector2f size, string? id = null, string tag = "rectangle") : base(size)
        {
            Id = string.IsNullOrEmpty(id) ? Guid.NewGuid().ToString() : id;
            Tag = tag;
            DrawingIndex = 0;
        ...
        public GameRectangleShape(GameRectangleShape copyShape, string? id = null, string tag = "rectangle") : base(copyShape)
        {
            Id = string.IsNullOrEmpty(id) ? Guid.NewGuid().ToString() : id;
            Tag = tag;
